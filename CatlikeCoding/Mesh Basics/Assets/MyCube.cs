...
public class MyCube : MonoBehaviour
{
	...
	void CreateVertices()
	{
		...
		{
			for (int x = 0; x <= xSize; x++) vertices[v++] = new Vector3(x, y, 0);
			for (int z = 1; z <= zSize; z++) vertices[v++] = new Vector3(xSize, y, z);
			for (int x = xSize - 1; x >= 0; x--) vertices[v++] = new Vector3(x, y, zSize);
			for (int z = zSize - 1; z > 0; z--) vertices[v++] = new Vector3(0, y, z);
		}
